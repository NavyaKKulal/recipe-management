...
<body>
    <div class="container">
        ...
        <a href="my_recipe.php" style="display: inline-block; margin-top: 20px; padding: 10px 15px; background: #007bff; color: white; text-decoration: none; border-radius: 5px;">Back to My Recipes</a>
    </div>
</body>
</html>
